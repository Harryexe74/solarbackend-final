...
import productRoutes from "./routes/productRoutes.js";
import orderRoutes from "./routes/orderRoutes.js"; // Fixed typo from 'oderRoutes' to 'orderRoutes'
import subscriberRoutes from "./routes/subscriberRoutes.js"; // Changed variable name to reflect it's a routes module
...
const corsOptions = {
  origin: [
    ...
    'https://solar-admin-frontend-amber.vercel.app'
  ],
...
app.use("/api/subscribers", subscriberRoutes); // Use the correct variable name
